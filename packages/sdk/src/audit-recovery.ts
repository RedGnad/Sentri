...
function mapInferenceOntoEntry(
  ...
  return {
    ...entry,
    source,
    txHash: entry.txHash ?? (typeof inference.txHash === "string" ? inference.txHash : undefined),
    amount: inference.amount,
    amountIn: inference.amountIn ?? entry.amountIn,
    amountOut: inference.amountOut ?? entry.amountOut,
    ...
    AgentINFT: inference.AgentINFT,
    oracleMode: inference.oracleMode,
    pythPriceId: inference.pythPriceId,
    pythPrice: inference.pythPrice,
    pythPublishTime: inference.pythPublishTime,
    pythConfBps: inference.pythConfBps,
    confidenceBps: inference.confidenceBps,
    plannedAction: inference.plannedAction,
    executionLogCount: inference.executionLogCount,
    preTxRootHash: inference.preTxRootHash,
    preTxStorageTxHash: inference.preTxStorageTxHash,
    ...
    storageTxHash: storage?.txHash ?? undefined,
    storageRootHash: storage?.rootHash ?? undefined,
